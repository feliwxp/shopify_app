import { Client } from "@gadget-client/feliwxp";
...
export interface RouteContext<Description extends RequestDescription = RequestDescription> extends FastifyRequest<Description> {
    ...
    /** All Feliwxp configuration values */
    config: AppConfiguration;
    /** A map of connection name to instantiated connection objects for Feliwxp */
    ...
    /**
     * An instance of the API client for Feliwxp.
     *
