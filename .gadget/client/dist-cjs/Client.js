...
class Client {
  constructor(options) {
    this.developmentApiRoot = "https://feliwxp--development.gadget.app/";
    this.productionApiRoot = "https://feliwxp.gadget.app/";
    this.applicationId = "50551";
    ...
    */
    ...
    this.internal = {
      ...
      token: new import_api_client_core.InternalModelManager("token", this.connection, {
