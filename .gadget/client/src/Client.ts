...
export class Client implements AnyClient {
  ...
  */
  ...
  developmentApiRoot = "https://feliwxp--development.gadget.app/";
  productionApiRoot = "https://feliwxp.gadget.app/";
  applicationId = "50551";
  ...
  constructor(options?: ClientOptions) {
    ...
    this.internal = {
      ...
      token: new InternalModelManager("token", this.connection, {
