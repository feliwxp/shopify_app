...
export interface TokenFilter {
  AND?: (TokenFilter | null)[];
  OR?: (TokenFilter | null)[];
  NOT?: (TokenFilter | null)[];
  id?: IDFilter | null;
  createdAt?: DateTimeFilter | null;
  updatedAt?: DateTimeFilter | null;
...
/** A connection to a list of Token items. */
...
export type AvailableTokenConnectionSelection = {

  __typename?: boolean | null | undefined;

  /** A list of edges. */
  edges?: AvailableTokenEdgeSelection;
...
export type AvailableTokenEdgeSelection = {

  __typename?: boolean | null | undefined;

  /** The item at the end of the edge */
  node?: AvailableTokenSelection;
...
export type AvailableTokenSelection = {
...
/** A connection to a list of InternalTokenRecord items. */
export interface InternalTokenRecordConnection {
  __typename: 'InternalTokenRecordConnection';
  /** A list of edges. */
  edges: InternalTokenRecordEdge[];
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};
...
export type AvailableInternalTokenRecordConnectionSelection = {

  __typename?: boolean | null | undefined;

  /** A list of edges. */
  edges?: AvailableInternalTokenRecordEdgeSelection;
...
/** An edge in a InternalTokenRecord connection. */
export interface InternalTokenRecordEdge {
  __typename: 'InternalTokenRecordEdge';
  /** The item at the end of the edge */
  node: InternalTokenRecord;
  /** A cursor for use in pagination */
  cursor: Scalars['String'];
};
...
export type AvailableInternalTokenRecordEdgeSelection = {
...
export interface Mutation {
  ...
  createToken: (CreateTokenResult | null);
...
export type AvailableMutationSelection = {
  ...
  createToken?: AvailableCreateTokenResultSelection;
...
export type AvailableCreateTokenResultSelection = {
...
export type AvailableUpdateTokenResultSelection = {
...
export type AvailableDeleteTokenResultSelection = {
...
export interface BulkDeleteTokensResult {
  __typename: 'BulkDeleteTokensResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
};
...
export type AvailableBulkDeleteTokensResultSelection = {
...
export interface InternalMutations {
  ...
  createToken: (InternalCreateTokenResult | null);
  updateToken: (InternalUpdateTokenResult | null);
  deleteToken: (InternalDeleteTokenResult | null);
  deleteManyToken: (InternalDeleteManyTokenResult | null);
  bulkCreateTokens: (InternalBulkCreateTokensResult | null);
...
export type AvailableInternalMutationsSelection = {
  ...
  createToken?: AvailableInternalCreateTokenResultSelection;

  updateToken?: AvailableInternalUpdateTokenResultSelection;

  deleteToken?: AvailableInternalDeleteTokenResultSelection;

  deleteManyToken?: AvailableInternalDeleteManyTokenResultSelection;

  bulkCreateTokens?: AvailableInternalBulkCreateTokensResultSelection;
...
export interface CreateShopifyGdprRequestResult {
...
export interface UpdateShopifyGdprRequestResult {
...
export interface UpdateShopifyProductResult {
...
export interface DeleteShopifyProductResult {
...
export interface UpdateShopifyShopResult {
...
export interface InstallShopifyShopResult {
...
export interface UninstallShopifyShopResult {
...
export interface ReinstallShopifyShopResult {
...
export interface InternalCreateTokenResult {
  __typename: 'InternalCreateTokenResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
  token: (InternalTokenRecord | null);
};
...
export type AvailableInternalCreateTokenResultSelection = {
...
export interface InternalUpdateTokenResult {
  __typename: 'InternalUpdateTokenResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
  token: (InternalTokenRecord | null);
};
...
export type AvailableInternalUpdateTokenResultSelection = {
...
export interface InternalDeleteTokenResult {
  __typename: 'InternalDeleteTokenResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
  token: (InternalTokenRecord | null);
};
...
export type AvailableInternalDeleteTokenResultSelection = {
...
export interface InternalDeleteManyTokenResult {
  __typename: 'InternalDeleteManyTokenResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
};
...
export type AvailableInternalDeleteManyTokenResultSelection = {
...
export interface InternalBulkCreateTokensResult {
  __typename: 'InternalBulkCreateTokensResult';
  success: Scalars['Boolean'];
  errors: ExecutionError[];
  tokens: (InternalTokenRecord | null)[];
};



export type AvailableInternalBulkCreateTokensResultSelection = {
